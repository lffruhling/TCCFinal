...
<div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active"><a href="grupo_prod_list.php">Grupo de Produtos</a></li>&nbsp;<i class="fa fa-angle-right"></i>&nbsp;</li>
            <li class="active">Cadastro de Grupo de Produtos</li>
        </ol>
        <div class="clearfix">
        </div>
    </div>
                	...
                	<div class="row">
                    	<div class="col-lg-12">
                        	<div class="panel panel-green">
                            	<div class="panel-heading">Novo Grupo de Produtos</div>
                                	...
                                	<form action="#">
                                        ...
                                        <div class="form-actions text-right pal">
                                            <button type="button" class="btn btn-primary" onclick="cancelar();">
                                                Cancelar</button>
                                            <button type="button" class="btn btn-primary" onclick="cadastrar_grupo();">
                                                Salvar</button>
                                        </div>
									</form>
                                </div>
	...
	<script type="text/javascript">
        ...
        function cadastrar_grupo(){
			...
			if(nome==''){
				alert("Preencha o campo Nome do Grupo");
				return;
			}
			...
			pageurl = './ajax/cadastra_grupo.php';
