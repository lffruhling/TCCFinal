...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioNivel'] > $nivel_necessario)) {
    ...
    header("Location: grupo_prod_list.php");
    exit;
}
?>
<!DOCTYPE html>
...
<div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Edição de Grupo de Produtos</li>
        </ol>
        <div class="clearfix">
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">Edição Grupo de Produtos</div>
