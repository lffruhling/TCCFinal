...
$nome   = $db->_e_nome_cli($id);
$cnpj   = $db->_e_cnpj_cli($id);
$cpf    = $db->_e_cpf_cli($id);
$cep    = $db->_e_cep_cli($id);
$rua    = $db->_e_rua_cli($id);
$nro    = $db->_e_nro_cli($id);
$comp   = $db->_e_comp_cli($id);
$estado = $db->_e_estado_cli($id);
$cidade = $db->_e_cidade_cli($id);
$fone1  = $db->_e_fone1_cli($id);
$fone2  = $db->_e_fone2_cli($id);
$celular= $db->_e_celular_cli($id);
$email  = $db->_e_email_cli($id);
$ativo  = $db->_e_ativo_cli($id);
                                ...
                                <form action="#">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcnpj" type="number" placeholder="" class="form-control" value="<?php echo $cnpj ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcpf" type="number" placeholder="" class="form-control" value="<?php echo $cpf ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        ...
                                                        <input id="inputcep" type="number" placeholder="" class="form-control" required="" value="<?php echo $cep ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-map-marker"></i>
                                                        <input id="inputrua" type="text" placeholder="" class="form-control" required="" value="<?php echo $rua ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-map-marker"></i>
                                                        <input id="inputnro" type="text" placeholder="" class="form-control" required="" value="<?php echo $nro ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-map-marker"></i>
                                                        <input id="inputcomp" type="text" placeholder="" class="form-control" value="<?php echo $comp ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-map-marker"></i>
                                                        <input id="inputestado" type="texto" placeholder="" class="form-control" required="" value="<?php echo $estado ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-map-marker"></i>
                                                        <input id="inputcidade" type="texto" placeholder="" class="form-control" required="" value="<?php echo $cidade ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        ...
                                                        <input id="inputfone1" type="number" placeholder="" class="form-control" required="" value="<?php echo $fone1 ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-phone-square"></i>
                                                        <input id="inputfone2" type="number" placeholder="" class="form-control" value="<?php echo $fone2 ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        ...
                                                        <input id="inputcel" type="number" placeholder="" class="form-control" value="<?php echo $celular ?>"/></div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        ...
                                                        <input id="inputemail" type="text" placeholder="" class="form-control" value="<?php echo $email ?>"/></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-actions text-right pal">
                                        <button type="button" class="btn btn-primary" onclick="cancelar();">
                                            Cancelar</button>
                                        <button type="button" class="btn btn-primary" onclick="edita_cliente();">
                                            Salvar</button>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    function edita_cliente(){
        ...
        pageurl = './ajax/edita_cliente.php';
