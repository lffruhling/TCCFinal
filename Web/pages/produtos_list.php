...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
            ...
            <ol class="breadcrumb page-breadcrumb pull-right">
                ...
                <li class="hidden"><a href="#">Produtos</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
    ...
    <script type="text/javascript">
        function deletar(id){
            ...
            pageurl = 'ajax/deleta_produto.php';
        ...
        function editar(id){
            ...
            open("produtos_edit.php?id="+id,"_self");
