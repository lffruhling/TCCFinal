...
<div id="wrapper">
            ...
            <div class="page-header pull-left">
                <div class="page-title">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg" onclick="abre_iframe();">
                        Novo Tipo de Serviço</button>
                </div>
            </div>
            <ol class="breadcrumb page-breadcrumb pull-right">
                <li><i class="fa fa-home"></i>&nbsp;<a href="menu.php">Home</a>&nbsp;&nbsp;<i
                        class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                <li class="hidden"><a href="#">Tipos de Serviços</a>&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;</li>
                <li class="active">Tipos de Serviços</li>
            </ol>
            <div class="clearfix">
            </div>
        </div>
            ...
            <div id="tab-general">
                <div class="row mbl">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">Tipos de serviços Cadastrados</div>
    ...
    <script type="text/javascript">
        function deletar(id){
            ...
            pageurl = 'ajax/deleta_tipo_serv.php';
        ...
        function editar(id){
            ...
            open("tipo_serv_edit.php?id="+id,"_self");
