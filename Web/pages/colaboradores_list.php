...
<body>
            ...
            <div id="tab-general">
                <div class="row mbl">
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">Colaboradores Cadastrados</div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#dynamictable').dataTable( {
                ...
                "serverSide": true,
                "ajax": {
                    "url": "table/colaboradores_table.php",
                    "type": "POST"
                },
                "language": {
    ...
    <script type="text/javascript">
        ...
        function editar(id){
            ...
            open("colaboradores_edit.php?id="+id,"_self");
