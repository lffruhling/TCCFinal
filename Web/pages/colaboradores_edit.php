...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioNivel'] > $nivel_necessario)) {
    ...
    header("Location: colaboradores_list.php");
    exit;
}
?>
<!DOCTYPE html>
...
$nome       = $db->_e_nome_colab($id);
$perfil     = $db->_e_perfil_colab($id);
...
$cpf        = $db->_e_cpf_colab($id);
$dt_nasc    = $db->_e_dt_nasc_colab($id);
$cep        = $db->_e_cep_colab($id);
$rua        = $db->_e_rua_colab($id);
$nro        = $db->_e_nro_colab($id);
$bairro     = $db->_e_bairro_colab($id);
$comp       = $db->_e_comp_colab($id);
$estado     = $db->_e_estado_colab($id);
$cidade     = $db->_e_cid_colab($id);
$fone       = $db->_e_fone1_colab($id);
$cel        = $db->_e_cel_colab($id);
$email      = $db->_e_email_colab($id);
$usuario    = $db->_e_usuario_colab($id);
$senha      = $db->_e_senha_colab($id);
$ativo      = $db->_e_ativo_colab($id);
...
<div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
    ...
    <ol class="breadcrumb page-breadcrumb pull-right">
        ...
        <li class="active">Edição de Colaborador</li>
    </ol>
    <div class="clearfix">
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">Edição de Colaborador</div>
                                ...
                                <form action="#">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcpf" type="number" placeholder="" class="form-control" value="<?php echo $cpf ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputdtnasc" type="date" placeholder="" class="form-control" value="<?php echo $dt_nasc ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcep" type="number" placeholder="" class="form-control" value="<?php echo $cep ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputend" type="text" placeholder="" class="form-control" value="<?php echo $rua ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputnro" type="text" placeholder="" class="form-control" value="<?php echo $nro ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputbairro" type="text" placeholder="" class="form-control" value="<?php echo $bairro ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcomp" type="text" placeholder="" class="form-control" value="<?php echo $comp ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputestado" type="text" placeholder="" class="form-control" value="<?php echo $estado ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcid" type="text" placeholder="" class="form-control" value="<?php echo $cidade ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputfone" type="number" placeholder="" class="form-control" value="<?php echo $fone ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputcel" type="number" placeholder="" class="form-control" required="" value="<?php echo $cel ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputemail" type="text" placeholder="" class="form-control" required="" value="<?php echo $email ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-icon right">
                                                        <i class="fa fa-user"></i>
                                                        <input id="inputuser" type="text" placeholder="" class="form-control" required="" value="<?php echo $usuario ?>"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                    ...
                                    <div class="form-actions text-right pal">
                                        <button type="button" class="btn btn-primary" onclick="cancelar();">
                                            Cancelar</button>
                                        <button type="button" class="btn btn-primary" onclick="editar_colab();">
                                            Salvar</button>
                                    </div>
                                </form>
                            </div>
