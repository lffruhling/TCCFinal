...
if (!isset($_SESSION['UsuarioID']) OR ($_SESSION['UsuarioNivel'] > $nivel_necessario)) {
    ...
    header("Location: tipo_serv_list.php");
    exit;
}
?>
<!DOCTYPE html>
...
$nome  = $db->_e_nome_tipo_serv($id);
$ativo = $db->_e_ativo_tipo_serv($id);
...
<div id="page-wrapper">
    ...
    <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
        ...
        <ol class="breadcrumb page-breadcrumb pull-right">
            ...
            <li class="active">Edição de Tipos de Serviços</li>
        </ol>
        <div class="clearfix">
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">Edição de Tipo de Serviço</div>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-actions text-right pal">
                                        <button type="button" class="btn btn-primary" onclick="cancelar();">
                                            Cancelar</button>
                                        <button type="button" class="btn btn-primary" onclick="editar_tipo_serv();">
                                            Salvar</button>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    function editar_tipo_serv(){
        ...
        pageurl = './ajax/edita_tipo_serv.php';
        ...
        $.ajax({
            ...
            {
                if(result=='1'){
                    alert('Tipo de Serviço editado com sucesso');
                    $('#inputname').val('');
                    $('#inputativo').val('');
                    ...
                    alert('Erro ao editar Tipo de Serviço');
                } else {alert(result);}
            }
        });
    }
